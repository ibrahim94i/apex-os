...
export const t = {
  ...
  newsLastAt: "آخر خبر حديث",
  newsRecentCount: "أخبار حديثة (<1س)",
  newsNoRecent: "⚠️ لا أخبار حديثة",
  ruleBased: "قواعد",
  tradingTab: "التداول",
  ...
  opensIn: "يفتح خلال",
  closesIn: "يغلق خلال",
  marketOpensAt: "موعد الفتح",
  marketClosesAt: "موعد الإغلاق",
  iraqTime: "توقيت العراق",
